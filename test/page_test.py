...
def page_sites_test():
    pages = [
        ...
        check_page('https://markseaman.org/MarkSeaman/Index.md',        160, 180),

        check_page('https://seamansguide.com/guide/Index.md',           112, 130),
        check_page('https://seamanslog.com/seamanslog/List',            124, 127),
        check_page('https://seamanslog.com/seamanslog/Files',           124, 127),
